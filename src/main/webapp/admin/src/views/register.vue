  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">新能源汽车在线租赁注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																								...
																								<!-- <div v-if="tableName=='zhandianguanliyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='zhandianguanliyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zhandianguanliyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='zhandianguanliyuan'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='zhandianguanliyuan'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='zhandianguanliyuan'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='zhandianguanliyuan'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='zhandianguanliyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.zhanghao) && `zhandianguanliyuan` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `zhandianguanliyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`zhandianguanliyuan` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201205/d21ac849e0ac47c389665c994ad8601d.jpg");
		height: 100vh;
