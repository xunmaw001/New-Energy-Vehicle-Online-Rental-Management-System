          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="还车状况" prop="haichezhuangkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="还车状况"
                  v-model="ruleForm.haichezhuangkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.haichezhuangkuang" label="还车状况" prop="haichezhuangkuang">
                    <span>{{ruleForm.haichezhuangkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='haichezhuangkuang'){
            this.ruleForm.haichezhuangkuang = obj[o];
	    this.ro.haichezhuangkuang = true;
            continue;
          }
	            	            if(o=='haicheriqi'){
