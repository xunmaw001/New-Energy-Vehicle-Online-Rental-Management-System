...
export default {
  ...
  computed: {
                                                                                                zongjiage:{
                                                                                                                                                                                                                                get: function () {
        return 1*this.ruleForm.shijiage*this.ruleForm.zulinshijian
      }
    },
                                                                                      },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiechexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiechexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
